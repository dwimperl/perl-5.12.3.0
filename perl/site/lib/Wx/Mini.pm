...
our $alien_key = 'msw_2_8_12_uni_gcc_3_4';

{
    my $VAR1;
    $Wx::dlls = $VAR1 = {
          'base' => 'wxbase28u_gcc_custom.dll',
          'core' => 'wxmsw28u_core_gcc_custom.dll',
          'richtext' => 'wxmsw28u_richtext_gcc_custom.dll',
          'aui' => 'wxmsw28u_aui_gcc_custom.dll',
          'stc' => 'wxmsw28u_stc_gcc_custom.dll',
          'gl' => 'wxmsw28u_gl_gcc_custom.dll',
          'net' => 'wxbase28u_net_gcc_custom.dll',
          'html' => 'wxmsw28u_html_gcc_custom.dll',
          'xml' => 'wxbase28u_xml_gcc_custom.dll',
          'media' => 'wxmsw28u_media_gcc_custom.dll',
          'xrc' => 'wxmsw28u_xrc_gcc_custom.dll',
          'adv' => 'wxmsw28u_adv_gcc_custom.dll'
        };
;
}
...
sub _alien_path {
  ...
  return unless length 'msw_2_8_12_uni_gcc_3_4';
  foreach ( @INC ) {
    if( -d "$_/Alien/wxWidgets/msw_2_8_12_uni_gcc_3_4" ) {
      $wx_path = "$_/Alien/wxWidgets/msw_2_8_12_uni_gcc_3_4/lib";
      last;
    }
  }
}
